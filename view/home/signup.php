...
<br> </br>
    ...
    <form action="store.php" method="POST" class="col-4 login" autocomplete="off">
        <div class="mb-3">
    ...
    if (!empty($_POST['contraseña']) && !validar_contrasena($_POST['contraseña'])) {
        echo '<div class="alert-warning">La contraseña no cumple con los requisitos .</div>';
    ...
    ?>
        ...
        <?php if (!empty($_GET['error'])): ?>
            <div id="alertError" style="margin: auto;" class="alert alert-warning" role="alert">
